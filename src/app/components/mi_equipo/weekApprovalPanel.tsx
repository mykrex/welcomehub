...
export const WeekApprovalPanel: React.FC<WeekApprovalPanelProps> = ({
  ...
  const formatISODate = (isoDateString: string): string => {
    ...
    try {
      const dateToFormat = isoDateString.includes("T")
        ? isoDateString
        : `${isoDateString}T12:00:00`;
  ...
  return (
    <div className="approval-panel">
      <div className="week-status">
        ...
        <p>
          <strong>Horas totales:</strong> {week.horas_totales}h
        </p>
      </div>
      ...
      {isApproved && <div className="approved-badge">✔ Semana Aprobada</div>}
