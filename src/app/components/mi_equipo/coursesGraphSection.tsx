...
export const CoursesGraphSection: React.FC<CoursesSectionProps> = ({
  employee,
}) => {
  const normalCourses = employee.courses || {
    completed: 0,
    inProgress: 0,
    notStarted: 0,
  };
  const obligatoryCourses = employee.obligatoryCourses || {
    completed: 0,
    inProgress: 0,
    notStarted: 0,
  };
  ...
  const courseGraphData = [
    {
      ...
      normal: Math.max(
        0,
        normalCourses.completed - obligatoryCourses.completed
      ),
    ...
    },
    {
      ...
      normal: Math.max(
        0,
        normalCourses.inProgress - obligatoryCourses.inProgress
      ),
    ...
    },
    {
      ...
      normal: Math.max(
        0,
        normalCourses.notStarted - obligatoryCourses.notStarted
      ),
