    ...
    <div className="p-6 bg-[#042C45] rounded-lg space-y-6">
      ...
      <div className="flex flex-col items-center text-center space-y-4">
        ...
        <p className="text-gray-400 text-lg">
          Somos una aceleradora digital global que ayuda a las empresas a
          reinventarse mediante soluciones tecnológicas innovadoras. Combinamos
          experiencia en la industria con pensamiento disruptivo para generar
          impacto real.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="flex flex-col items-center bg-[#333] p-6 rounded-lg space-y-4 border-b-4 border-[#448AFF]">
          ...
          <p className="text-gray-400 text-center">
            Estamos presentes en más de 10 países, conectando talento
            multicultural para impulsar el cambio digital.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center bg-[#333] p-6 rounded-lg space-y-4 border-b-4 border-[#06D6A0]">
          ...
          <p className="text-gray-400 text-center">
            Nuestro equipo combina experiencia tecnológica con un enfoque humano
            para construir soluciones personalizadas.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center bg-[#333] p-6 rounded-lg space-y-4 border-b-4 border-[#F57C00]">
          ...
          <p className="text-gray-400 text-center">
            Apostamos por la innovación continua como motor para transformar
            industrias y crear valor sostenible.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6">
        <div className="flex flex-col items-center bg-[#1C3A4E] p-6 rounded-lg space-y-4 border-l-4 border-[#FFD166]">
          ...
          <p className="text-gray-400 text-center">
            Empoderar a nuestros clientes para alcanzar sus objetivos a través
            de la tecnología, la creatividad y el conocimiento profundo de la
            industria.
          </p>
        </div>
        <div className="flex flex-col items-center bg-[#1C3A4E] p-6 rounded-lg space-y-4 border-l-4 border-[#EF476F]">
          ...
          <p className="text-gray-400 text-center">
            Nos guiamos por la integridad, el compromiso, la colaboración y la
            pasión por entregar resultados excepcionales.
          </p>
        </div>
      </div>
      ...
      <div className="pt-10">
        <h2 className="text-[32px] font-bold text-[#448AFF] text-center mb-12">
          Línea del Tiempo NEORIS
        </h2>
        <div className="relative border-l-4 border-[#448AFF] ml-6 space-y-12">
          {[
            ...
            <div key={index} className="relative">
              <div
                className="absolute -left-[42px] top-1 w-5 h-5 rounded-full border-4"
                style={{ backgroundColor: event.color, borderColor: "#042C45" }}
              />
              <div className="ml-4">
